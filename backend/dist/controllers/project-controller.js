...
exports.createProjectController = (0, async_handler_1.asyncHandler)(async (req, res) => {
...
exports.getAllProjectsInWorkspaceController = (0, async_handler_1.asyncHandler)(async (req, res) => {
    const workspaceId = workspace_validation_1.workspaceIdSchema.parse(req.params.workspaceId);
    const userId = req.user?._id;
    const { role } = await (0, member_service_1.getMemberRoleInWorkspace)(userId, workspaceId);
...
exports.getProjectByIdAndWorkspaceIdController = (0, async_handler_1.asyncHandler)(async (req, res) => {
...
exports.getProjectAnalyticsController = (0, async_handler_1.asyncHandler)(async (req, res) => {
    const projectId = project_validation_1.projectIdSchema.parse(req.params.id);
    const workspaceId = workspace_validation_1.workspaceIdSchema.parse(req.params.workspaceId);
    const userId = req.user?._id;
    const { role } = await (0, member_service_1.getMemberRoleInWorkspace)(userId, workspaceId);
...
exports.updateProjectController = (0, async_handler_1.asyncHandler)(async (req, res) => {
    const userId = req.user?._id;
    const projectId = project_validation_1.projectIdSchema.parse(req.params.id);
    const workspaceId = workspace_validation_1.workspaceIdSchema.parse(req.params.workspaceId);
...
exports.deleteProjectController = (0, async_handler_1.asyncHandler)(async (req, res) => {
    const userId = req.user?._id;
    const projectId = project_validation_1.projectIdSchema.parse(req.params.id);
    const workspaceId = workspace_validation_1.workspaceIdSchema.parse(req.params.workspaceId);
    const { role } = await (0, member_service_1.getMemberRoleInWorkspace)(userId, workspaceId);
