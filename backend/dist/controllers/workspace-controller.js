...
exports.createWorkspaceController = (0, async_handler_1.asyncHandler)(async (req, res) => {
...
exports.getAllWorkspacesUserIsMemberController = (0, async_handler_1.asyncHandler)(async (req, res) => {
    const userId = req.user?._id;
...
exports.getWorkspaceByIdController = (0, async_handler_1.asyncHandler)(async (req, res) => {
...
exports.getWorkspaceMembersController = (0, async_handler_1.asyncHandler)(async (req, res) => {
    const workspaceId = workspace_validation_1.workspaceIdSchema.parse(req.params.id);
    const userId = req.user?._id;
...
exports.getWorkspaceAnalyticsController = (0, async_handler_1.asyncHandler)(async (req, res) => {
    const workspaceId = workspace_validation_1.workspaceIdSchema.parse(req.params.id);
    const userId = req.user?._id;
    const { role } = await (0, member_service_1.getMemberRoleInWorkspace)(userId, workspaceId);
    (0, role_guard_1.roleGuard)(role, [role_enum_1.Permissions.VIEW_ONLY]);
...
exports.changeWorkspaceMemberRoleController = (0, async_handler_1.asyncHandler)(async (req, res) => {
    const workspaceId = workspace_validation_1.workspaceIdSchema.parse(req.params.id);
...
exports.updateWorkspaceByIdController = (0, async_handler_1.asyncHandler)(async (req, res) => {
    const workspaceId = workspace_validation_1.workspaceIdSchema.parse(req.params.id);
...
exports.deleteWorkspaceByIdController = (0, async_handler_1.asyncHandler)(async (req, res) => {
    const workspaceId = workspace_validation_1.workspaceIdSchema.parse(req.params.id);
    const userId = req.user?._id;
    const { role } = await (0, member_service_1.getMemberRoleInWorkspace)(userId, workspaceId);
